        ...
        <form class="checkout-invoice__form">
            <fieldset class="checkout-invoice__fieldset">
                ...
                <div class="checkout-invoice__type-group">
                    <button type="button" class="checkout-invoice__type-btn" data-page="checkout3_1">
                        <p>電子發票</p>
                    </button>
                    <button type="button" class="checkout-invoice__type-btn checkout-invoice__type-btn--active"
                ...
                <!-- 郵寄地址 -->
                <div class="checkout-invoice__field checkout-invoice__field--address">
                    <div class="checkout-invoice__address-header">
                        <label for="address" class="checkout-invoice__label">地址</label>
                        <div class="checkout-invoice__checkbox-wrap">
                            <input type="checkbox" id="same-as-shipping" class="checkout-invoice__checkbox">
                            <label for="same-as-shipping" class="checkout-invoice__checkbox-label">同運送地址</label>
                        </div>
                    </div>

                    <div class="checkout-invoice__select-group">
                        <select name="city" id="city" class="checkout-invoice__select">
                            <option value="臺北市">臺北市</option>
                            <option value="臺中市">臺中市</option>
                            <option value="高雄市" selected>高雄市</option>
                        </select>
                        <select name="district" id="district" class="checkout-invoice__select">
                            <option value="新興區" selected>新興區</option>
                        </select>
                    </div>

                    <input type="text" id="address" placeholder="幸福路 520 號" class="checkout-invoice__input">
                </div>
